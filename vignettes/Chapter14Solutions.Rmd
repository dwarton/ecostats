...
![plot of chunk code14.2](figure/code14.2-1.png)
...
![plot of chunk code14.3](figure/code14.3-1.png)
...
![plot of chunk code14.3MV](figure/code14.3MV-1.png)
...
![plot of chunk ex14.5](figure/ex14.5-1.png)
...
![plot of chunk ex14.6assumptions](figure/ex14.6assumptions-1.png)
...
![plot of chunk ex14.6refit](figure/ex14.6refit-1.png)
...
#>         Bergvar         Oxsimpa         Piggvar      Roodspotta       Rootsimpa     Sandskaadda         Sjurygg   Skrubbskaadda     Skaaggsimpa 
#>               0              51               1               3              30               5               6              22               6 
#>    Skaarsnultra     Stensnultra Svart.smoorbult           Torsk        Tanglake     Aakta.tunga              AL 
#>               4              37               3             134             136               0              61
```
...
#>       Amph        Cope            Poly            Anem             Iso            Bival            Gast            Turb             Prawn       
#>  Min.   :2   Min.   :0.000   Min.   :0.000   Min.   :0.0000   Min.   :0.000   Min.   :0.000   Min.   :1.000   Min.   :0.00000   Min.   :0.0000  
#>  1st Qu.:2   1st Qu.:2.000   1st Qu.:2.000   1st Qu.:0.0000   1st Qu.:2.000   1st Qu.:0.000   1st Qu.:2.000   1st Qu.:0.00000   1st Qu.:0.0000  
#>  Median :2   Median :2.000   Median :2.000   Median :0.0000   Median :2.000   Median :2.000   Median :2.000   Median :0.00000   Median :0.0000  
#>  Mean   :2   Mean   :1.895   Mean   :1.772   Mean   :0.2456   Mean   :1.877   Mean   :1.351   Mean   :1.947   Mean   :0.08772   Mean   :0.5263  
#>  3rd Qu.:2   3rd Qu.:2.000   3rd Qu.:2.000   3rd Qu.:0.0000   3rd Qu.:2.000   3rd Qu.:2.000   3rd Qu.:2.000   3rd Qu.:0.00000   3rd Qu.:2.0000  
#>  Max.   :2   Max.   :2.000   Max.   :2.000   Max.   :2.0000   Max.   :2.000   Max.   :2.000   Max.   :2.000   Max.   :2.00000   Max.   :2.0000  
#>      Urchin             Fish             Crab            Caddis             Opi              Ost            Bstar       
#>  Min.   :0.00000   Min.   :0.0000   Min.   :0.0000   Min.   :0.00000   Min.   :0.0000   Min.   :0.000   Min.   :0.0000  
#>  1st Qu.:0.00000   1st Qu.:0.0000   1st Qu.:0.0000   1st Qu.:0.00000   1st Qu.:0.0000   1st Qu.:0.000   1st Qu.:0.0000  
#>  Median :0.00000   Median :0.0000   Median :0.0000   Median :0.00000   Median :0.0000   Median :2.000   Median :0.0000  
#>  Mean   :0.07018   Mean   :0.1754   Mean   :0.5965   Mean   :0.03509   Mean   :0.1404   Mean   :1.404   Mean   :0.2105  
#>  3rd Qu.:0.00000   3rd Qu.:0.0000   3rd Qu.:2.0000   3rd Qu.:0.00000   3rd Qu.:0.0000   3rd Qu.:2.000   3rd Qu.:0.0000  
#>  Max.   :2.00000   Max.   :2.0000   Max.   :2.0000   Max.   :2.00000   Max.   :2.0000   Max.   :2.000   Max.   :2.0000
...
#> 
#> Univariate Tests:
#>             Acarina          Amphipoda          Araneae          Blattodea          Coleoptera          Collembola          Dermaptera         
#>                 Dev Pr(>Dev)       Dev Pr(>Dev)     Dev Pr(>Dev)       Dev Pr(>Dev)        Dev Pr(>Dev)        Dev Pr(>Dev)        Dev Pr(>Dev)
#> (Intercept)                                                                                                                                    
#> treatment     8.538    0.183     9.363    0.155   0.493    0.976    10.679    0.118      9.741    0.143      6.786    0.297      0.196    0.976
#>             Diotocardia          Diplura          Diptera          Formicidae          Haplotaxida          Hemiptera          Hymenoptera         
#>                     Dev Pr(>Dev)     Dev Pr(>Dev)     Dev Pr(>Dev)        Dev Pr(>Dev)         Dev Pr(>Dev)       Dev Pr(>Dev)         Dev Pr(>Dev)
#> (Intercept)                                                                                                                                        
#> treatment             0    0.983    2.24    0.840    5.93    0.348      0.831    0.973       2.889    0.766     1.302    0.967       4.254    0.528
#>             Isopoda          Larvae          Lepidoptera          Polydesmida          Pseudoscorpionida          Scolopendrida          Seolifera
#>                 Dev Pr(>Dev)    Dev Pr(>Dev)         Dev Pr(>Dev)         Dev Pr(>Dev)               Dev Pr(>Dev)           Dev Pr(>Dev)       Dev
#> (Intercept)                                                                                                                                       
#> treatment     1.096    0.973  0.463    0.976       0.913    0.973       1.451    0.957             1.056    0.973         0.913    0.973      1.03
#>                      Soleolifera          Thysanoptera          Tricladida         
#>             Pr(>Dev)         Dev Pr(>Dev)          Dev Pr(>Dev)        Dev Pr(>Dev)
#> (Intercept)                                                                        
#> treatment      0.973       4.223    0.528        1.056    0.973      2.804    0.766
#> Arguments:
#>  Test statistics calculated assuming uncorrelated response (for faster computation) 
#> P-value calculated using 999 iterations via PIT-trap resampling.
```
...
#> Time elapsed: 0 hr 3 min 13 sec
