...
#>       Amph        Cope            Poly            Anem             Iso       
#>  Min.   :2   Min.   :0.000   Min.   :0.000   Min.   :0.0000   Min.   :0.000  
#>  1st Qu.:2   1st Qu.:2.000   1st Qu.:2.000   1st Qu.:0.0000   1st Qu.:2.000  
#>  Median :2   Median :2.000   Median :2.000   Median :0.0000   Median :2.000  
#>  Mean   :2   Mean   :1.895   Mean   :1.772   Mean   :0.2456   Mean   :1.877  
#>  3rd Qu.:2   3rd Qu.:2.000   3rd Qu.:2.000   3rd Qu.:0.0000   3rd Qu.:2.000  
#>  Max.   :2   Max.   :2.000   Max.   :2.000   Max.   :2.0000   Max.   :2.000  
#>      Bival            Gast            Turb             Prawn       
#>  Min.   :0.000   Min.   :1.000   Min.   :0.00000   Min.   :0.0000  
#>  1st Qu.:0.000   1st Qu.:2.000   1st Qu.:0.00000   1st Qu.:0.0000  
#>  Median :2.000   Median :2.000   Median :0.00000   Median :0.0000  
#>  Mean   :1.351   Mean   :1.947   Mean   :0.08772   Mean   :0.5263  
#>  3rd Qu.:2.000   3rd Qu.:2.000   3rd Qu.:0.00000   3rd Qu.:2.0000  
#>  Max.   :2.000   Max.   :2.000   Max.   :2.00000   Max.   :2.0000  
#>      Urchin             Fish             Crab            Caddis       
#>  Min.   :0.00000   Min.   :0.0000   Min.   :0.0000   Min.   :0.00000  
#>  1st Qu.:0.00000   1st Qu.:0.0000   1st Qu.:0.0000   1st Qu.:0.00000  
#>  Median :0.00000   Median :0.0000   Median :0.0000   Median :0.00000  
#>  Mean   :0.07018   Mean   :0.1754   Mean   :0.5965   Mean   :0.03509  
#>  3rd Qu.:0.00000   3rd Qu.:0.0000   3rd Qu.:2.0000   3rd Qu.:0.00000  
...
#> (Intercept)                                                                        
#> treatment        9.741    0.143      6.786    0.297      0.196    0.976           0
#>                      Diplura          Diptera          Formicidae         
#>             Pr(>Dev)     Dev Pr(>Dev)     Dev Pr(>Dev)        Dev Pr(>Dev)
#> (Intercept)                                                               
#> treatment      0.983    2.24    0.840    5.93    0.348      0.831    0.973
#>             Haplotaxida          Hemiptera          Hymenoptera          Isopoda
#>                     Dev Pr(>Dev)       Dev Pr(>Dev)         Dev Pr(>Dev)     Dev
#> (Intercept)                                                                     
#> treatment         2.889    0.766     1.302    0.967       4.254    0.528   1.096
#>                      Larvae          Lepidoptera          Polydesmida         
#>             Pr(>Dev)    Dev Pr(>Dev)         Dev Pr(>Dev)         Dev Pr(>Dev)
#> (Intercept)                                                                   
#> treatment      0.973  0.463    0.976       0.913    0.973       1.451    0.957
#>             Pseudoscorpionida          Scolopendrida          Seolifera         
#>                           Dev Pr(>Dev)           Dev Pr(>Dev)       Dev Pr(>Dev)
#> (Intercept)                                                                     
#> treatment               1.056    0.973         0.913    0.973      1.03    0.973
