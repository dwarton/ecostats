...
#> Warning in checkConv(attr(opt, "derivs"), opt$par, ctrl = control$checkConv, : Model failed to converge with max|grad| = 0.00715391 (tol = 0.002,
#> component 1)
...
#> Fixed Effects:
#>                (Intercept)            Treatmentpresent                        Time                   I(Time^2)       Treatmentpresent:Time  
#>                  6.5703718                  -0.2379806                  -0.1943256                   0.0028708                   0.0495183  
#> Treatmentpresent:I(Time^2)  
#>                 -0.0004498
anova(aphid_int)
