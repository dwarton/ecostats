...
#> soilp           64       1   4.475   0.123   
#> rain:soilp      63       1   3.371   0.180   
#> ---
#> Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
#> Arguments:
...
summary(spid_glmm)
#>  Family: poisson  ( log )
#> Formula:          abundance ~ genus + soil.dry:genus + moss:genus + (0 + genus |  
#>     rows)
...
#> Warning in fitTMB(TMBStruc): Model convergence problem; singular convergence (7).
