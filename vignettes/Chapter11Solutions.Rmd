...
![plot of chunk box11.2plot](figure/box11.2plot-1.png)
...
![plot of chunk box11.3](figure/box11.3-1.png)
...
#> soilp           64       1   4.475   0.127   
#> rain:soilp      63       1   3.371   0.196   
#> ---
#> Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
#> Arguments:
...
![plot of chunk ex11.4](figure/ex11.4-1.png)
...
![plot of chunk ex11.5Un](figure/ex11.5Un-1.png)
...
![plot of chunk ex11.5Log](figure/ex11.5Log-1.png)
...
```r
library(glmmTMB)
#> Warning: package 'glmmTMB' was built under R version 4.2.1
...
![plot of chunk code11.7hists](figure/code11.7hists-1.png)
...
![plot of chunk fig11.4](figure/fig11.4-1.png)
...
![plot of chunk code11.8](figure/code11.8-1.png)
...
![plot of chunk code11.9](figure/code11.9-1.png)
...
![plot of chunk ex11.7mcmc](figure/ex11.7mcmc-1.png)
