...
![plot of chunk fig10.5](figure/fig10.5-1.png)
...
![plot of chunk fig10.5](figure/fig10.5-2.png)
...
![plot of chunk box10.3](figure/box10.3-1.png)
...
![plot of chunk fig10.8](figure/fig10.8-1.png)

```r
plotenvelope(ftMany_crab, which=1, n.sim=39)
```

![plot of chunk fig10.8](figure/fig10.8-2.png)
...
![plot of chunk ex10.4](figure/ex10.4-1.png)
...
![plot of chunk box10.4](figure/box10.4-1.png)
...
![plot of chunk box10.4b](figure/box10.4b-1.png)
...
![plot of chunk ex10.5](figure/ex10.5-1.png)
...
![plot of chunk box10.6Poisson](figure/box10.6Poisson-1.png)
...
![plot of chunk box10.6NB](figure/box10.6NB-1.png)
...
#>             Res.Df Df.diff   Dev Pr(>Dev)  
#> (Intercept)     56                         
#> Time            55       1 6.670    0.012 *
#> Dist            53       2 1.026    0.646  
#> Time:Dist       51       2 0.401    0.860  
#> ---
#> Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
#> Arguments: P-value calculated using 999 iterations via PIT-trap resampling.
```
...
![plot of chunk box10.9Load](figure/box10.9Load-1.png)
...
![plot of chunk ex10.8P](figure/ex10.8P-1.png)
...
![plot of chunk ex10.8plot](figure/ex10.8plot-1.png)
...
![plot of chunk ex10.8NBplots](figure/ex10.8NBplots-1.png)
...
![plot of chunk ex10.10](figure/ex10.10-1.png)
