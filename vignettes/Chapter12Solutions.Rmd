...
for(iVar in 1:9)
  plotenvelope(lm(reveg$abund[,iVar]~fa_reveg$scores), which=2,main=names(reveg$abund)[iVar])
for(iVar in 1:9)
  plotenvelope(lm(reveg$abund[,iVar]~fa_reveg$scores), which=3,main=names(reveg$abund)[iVar])
```
