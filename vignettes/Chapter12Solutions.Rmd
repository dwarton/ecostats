...
![plot of chunk ex12.4RFplots](figure/ex12.4RFplots-1.png)
...
![plot of chunk ex12.4QQplots](figure/ex12.4QQplots-1.png)
...
#> reveg_LVM2  95 1569.899
#> reveg_LVM3 117 1629.363
#> reveg_LVM4 138 1587.444
#> reveg_LVM5 158 1602.782
```
...
#> Run 1 stress 0.1819872 
#> Run 2 stress 0.1641163 
#> Run 3 stress 0.1680773 
#> Run 4 stress 0.1923967 
#> Run 5 stress 0.1653221 
#> Run 6 stress 0.1923966 
#> Run 7 stress 0.2075317 
#> Run 8 stress 0.1611238 
#> ... Procrustes: rmse 0.0008583297  max resid 0.001554576 
#> ... Similar to previous best
#> Run 9 stress 0.1641162 
#> Run 10 stress 0.1641164 
#> Run 11 stress 0.1653221 
#> Run 12 stress 0.1934609 
#> Run 13 stress 0.1611236 
#> ... New best solution
#> ... Procrustes: rmse 0.0005031619  max resid 0.0009058036 
#> ... Similar to previous best
#> Run 14 stress 0.1659807 
#> Run 15 stress 0.1805824 
#> Run 16 stress 0.174544 
#> Run 17 stress 0.1611237 
#> ... Procrustes: rmse 0.0001254392  max resid 0.0002248365 
#> ... Similar to previous best
#> Run 18 stress 0.1680773 
#> Run 19 stress 0.1641161 
#> Run 20 stress 0.1611238 
#> ... Procrustes: rmse 0.000385828  max resid 0.000691825 
#> ... Similar to previous best
#> *** Solution reached
...
#> Run 1 stress 0.1068237 
#> Run 2 stress 0.1096403 
#> Run 3 stress 0.1042523 
#> Run 4 stress 0.1093951 
#> Run 5 stress 0.1026594 
#> Run 6 stress 0.1048121 
#> Run 7 stress 0.1217424 
#> Run 8 stress 0.09954197 
#> Run 9 stress 0.1255564 
#> Run 10 stress 0.1088713 
#> Run 11 stress 0.1172315 
#> Run 12 stress 0.1243951 
#> Run 13 stress 0.09954214 
#> Run 14 stress 0.1152297 
#> Run 15 stress 0.1257986 
#> Run 16 stress 0.1172314 
#> Run 17 stress 0.1284706 
#> Run 18 stress 0.1275011 
#> Run 19 stress 0.1244946 
#> Run 20 stress 0.1042511 
...
#> Run 1 stress 0.05741187 
#> ... New best solution
#> ... Procrustes: rmse 0.0007323776  max resid 0.00214931 
#> ... Similar to previous best
#> Run 2 stress 0.05741196 
#> ... Procrustes: rmse 5.344633e-05  max resid 0.0001573046 
#> ... Similar to previous best
#> Run 3 stress 0.0574119 
#> ... Procrustes: rmse 0.0007138967  max resid 0.002092021 
#> ... Similar to previous best
#> Run 4 stress 0.05741222 
#> ... Procrustes: rmse 0.000174726  max resid 0.0005233103 
#> ... Similar to previous best
#> Run 5 stress 0.05741186 
#> ... New best solution
#> ... Procrustes: rmse 0.0006913628  max resid 0.002031054 
#> ... Similar to previous best
#> Run 6 stress 0.05741169 
#> ... New best solution
#> ... Procrustes: rmse 0.0001261903  max resid 0.0003622647 
#> ... Similar to previous best
#> Run 7 stress 0.05741214 
#> ... Procrustes: rmse 0.0006915695  max resid 0.00205748 
#> ... Similar to previous best
#> Run 8 stress 0.07425302 
#> Run 9 stress 0.07425298 
#> Run 10 stress 0.0574116 
#> ... New best solution
#> ... Procrustes: rmse 0.0003000391  max resid 0.000882151 
#> ... Similar to previous best
#> Run 11 stress 0.0574119 
#> ... Procrustes: rmse 0.0004413087  max resid 0.001266712 
#> ... Similar to previous best
#> Run 12 stress 0.0574119 
#> ... Procrustes: rmse 0.0004457318  max resid 0.001283056 
#> ... Similar to previous best
#> Run 13 stress 0.05741227 
#> ... Procrustes: rmse 0.0004551786  max resid 0.001377039 
#> ... Similar to previous best
#> Run 14 stress 0.05741199 
#> ... Procrustes: rmse 0.0003376904  max resid 0.00101902 
#> ... Similar to previous best
#> Run 15 stress 0.05741175 
#> ... Procrustes: rmse 0.0001889044  max resid 0.000567864 
#> ... Similar to previous best
#> Run 16 stress 0.0574117 
#> ... Procrustes: rmse 0.0001409573  max resid 0.0004234382 
#> ... Similar to previous best
#> Run 17 stress 0.0574119 
#> ... Procrustes: rmse 0.0002847193  max resid 0.0008592249 
#> ... Similar to previous best
#> Run 18 stress 0.07425305 
#> Run 19 stress 0.05741191 
#> ... Procrustes: rmse 0.0004479513  max resid 0.001284921 
#> ... Similar to previous best
#> Run 20 stress 0.05741203 
#> ... Procrustes: rmse 0.0005138651  max resid 0.001470291 
#> ... Similar to previous best
#> *** Solution reached
