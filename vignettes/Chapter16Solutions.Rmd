...
#> iter  10 value 821.805630
#> iter  20 value 818.658041
#> iter  30 value 817.420228
#> iter  40 value 781.755656
#> iter  50 value 778.215211
#> final  value 777.933344 
#> converged
#>              soil.dry   bare.sand fallen.leaves       moss herb.layer reflection
#> Archetype1  1.5628882 -0.05472053    -0.2785304 -0.1449823  0.7081129 -0.4731397
#> Archetype2 -0.1067054  0.22426193    -0.2855950  0.4186594  0.5893706  0.4760833
```
...
![plot of chunk code16.2](figure/code16.2-1.png)
...
#> iter  10 value 740.900796
#> iter  20 value 740.884813
#> iter  30 value 740.865771
#> iter  40 value 740.817682
#> iter  50 value 739.833832
#> iter  60 value 728.725117
#> iter  70 value 728.591056
#> final  value 728.590862 
#> converged
#>            treatmentImpact
#> Archetype1        1.463471
#> Archetype2        1.463359
...
![plot of chunk code16.4](figure/code16.4-1.png)

```r
coefplot(ft_trait)
```

![plot of chunk code16.4](figure/code16.4-2.png)
...
![plot of chunk ex16.5](figure/ex16.5-1.png)

```r
coefplot(ft_anttrait)
```

![plot of chunk ex16.5](figure/ex16.5-2.png)
...
![plot of chunk code16.5](figure/code16.5-1.png)
